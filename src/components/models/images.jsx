...
const TextModel = () => {
  ...
  const data = [
    {
      id: 1,
      image1: "/models/logos/stability.svg",
      image2: "/models/logos/stability.svg",
      title: "Stability AI",
      description:
        "Deep learning, text-to-image model used to generate detailed images conditioned on text descriptions, inpainting, outpainting, and generating image-to-image translations.",
      tags: ["SDXL v0.8"],
    },
  ];
      ...
      >
        ...
        >
          <div className="md:w-1/2 md:mt-6 md:mb-6">
            <h1 className="text-3xl font-bold">Images Model</h1>
            <p
              className={`mt-2 ${
